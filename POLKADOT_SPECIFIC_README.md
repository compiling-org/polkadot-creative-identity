...
- Source module: `src/polkadot-client/`
- Extracted repo: `C:/Users/kapil/compiling/grant-repositories/polkadot-creative-identity`
- Real AI: TensorFlow.js inference available in demos; bridge logic pending deployment
- Tooling: Polkadot CLI and localnet setup pending
